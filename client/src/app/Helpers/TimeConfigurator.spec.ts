...
describe('TimeConfigurator', () => {
  ...
  it('should get timeColumnAsStringArray', () => {
    timeConfigurator = new TimeConfigurator(8, 0, 10, 0, shiftDate, 30);
    const expectedArray = [
      '08:00 - 08:30',
      '08:30 - 09:00',
      '09:00 - 09:30',
  ...
  it('should get correct timeColumnAsStringArray after midnight', () => {
    timeConfigurator = new TimeConfigurator(23, 0, 1, 0, shiftDate, 30);
    const expectedArray = [
      '23:00 - 23:30',
      '23:30 - 00:00',
      '00:00 - 00:30',
